...
--
-- Table structure for table `guilds_history_na`
--

DROP TABLE IF EXISTS `guilds_history_na`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guilds_history_na` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=57035 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
