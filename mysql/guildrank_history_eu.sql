...
--
-- Table structure for table `guildrank_history_eu`
--

DROP TABLE IF EXISTS `guildrank_history_eu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guildrank_history_eu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=133829 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
-- Dump completed on 2018-06-13 14:20:43
