...
--
-- Table structure for table `guilds_history_eu`
--

DROP TABLE IF EXISTS `guilds_history_eu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `guilds_history_eu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46550 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
-- Dump completed on 2018-06-13 14:20:47
